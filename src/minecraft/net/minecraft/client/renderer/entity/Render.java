...
import chickenware.events.EventType;
...
public abstract class Render
{
    ...
    {
    	EventRenderLivingLabel event = new EventRenderLivingLabel(p_147906_1_, p_147906_2_, p_147906_3_, p_147906_5_, p_147906_7_, p_147906_9_);
        event.setType(EventType.PRE);
        Client.onEvent(event);
        p_147906_2_ = event.text;
        p_147906_3_ = event.x;
        p_147906_5_ = event.y;
        p_147906_7_ = event.z;
        p_147906_9_ = event.maxDistance;
        ...
        if (var10 <= (double)(p_147906_9_ * p_147906_9_))
        {
            ...
            if(Client.isEnabled("NameTags") != null && (p_147906_1_ instanceof EntityPlayer))
            {
            	if(NameTags.moreInfoValue.get())
            	{
	                var18 = var12.getStringWidth("§lXXXXXXXXXXXXXXXX") / 2;
	                if(var12.getStringWidth("p_147906_2_") / 2 > var18) var18 = var12.getStringWidth("p_147906_2_") / 2;
	                var16.func_178960_a(0.0F, 0.0F, 0.0F, 0.5F);
		            var16.addVertex((double)(-var18 - 1), (double)(-12 + var17), 0.0D);
            ...
            {            	
            	if(NameTags.moreInfoValue.get())
            	{
	                ...
	                float h1 = ((EntityLivingBase)p_147906_1_).getHealth();
	                float d1 = (Minecraft.getMinecraft()).thePlayer.getDistanceToEntity(p_147906_1_);
	                String h2 = String.valueOf((int)h1);
	                String d2 = frmt.format(d1);
	                
	            	GlStateManager.func_179098_w();
	              	var12.drawStringWithShadow("§c§l❤§r §a§l" + String.valueOf(h2), -var18 + 2, var17 - 1, (h1 > 10.0F) ? -11141291 : ((h1 > 5.0F) ? -171 : -43691));
	              	var12.drawStringWithShadow("§9§l❤§r §a§l" + String.valueOf(((EntityLivingBase)p_147906_1_).getTotalArmorValue()), 0 - var12.getStringWidth("§9§l❤§r §a§l" + String.valueOf(((EntityLivingBase)p_147906_1_).getTotalArmorValue())) / 2, var17 - 1, (h1 > 10.0F) ? -11141291 : ((h1 > 5.0F) ? -171 : -43691));
	            	var12.drawStringWithShadow("§a§lD§r §c§l" + d2, var18 - var12.getStringWidth("§l§aD§r §c§l0.0"), var17 - 1, (d1 > 7.0F) ? -11141291 : ((d1 > 4.0F) ? -171 : -43691));
	            	
	                Gui.drawRect((-var18), (var17 + var12.FONT_HEIGHT - 1), (-var18 - 1) + (var18 * 2 + 2) * ((EntityLivingBase)p_147906_1_).getHealth() / ((EntityLivingBase)p_147906_1_).getMaxHealth(), (var17 + var12.FONT_HEIGHT), -1878982912);
	                Gui.drawRect((-var18), (var17 + var12.FONT_HEIGHT), (-var18 - 1 + (var18 * 2 + 2) * ((EntityLivingBase)p_147906_1_).getTotalArmorValue() / 20), (var17 + var12.FONT_HEIGHT + 1), -1879047937);
	                
	                Gui.drawRect((-var18), (var17 + var12.FONT_HEIGHT - 21), (-var18 - 1 + (var18 * 2 + 2)), (var17 + var12.FONT_HEIGHT - 22), 0xffffffff);
	                Gui.drawRect((-var18), (var17 + var12.FONT_HEIGHT + 1), (-var18 - 1 + (var18 * 2 + 2)), (var17 + var12.FONT_HEIGHT + 2), 0xffffffff);
	                Gui.drawRect((-var18 - 1), (var17 + var12.FONT_HEIGHT - 22), (-var18), (var17 + var12.FONT_HEIGHT + 2), 0xffffffff);
	                Gui.drawRect((-var18 - 1 + (var18 * 2 + 2)), (var17 + var12.FONT_HEIGHT - 22), (-var18 + (var18 * 2 + 2)), (var17 + var12.FONT_HEIGHT + 2), 0xffffffff);
	                
		            var12.drawStringWithShadow("§l"+ p_147906_2_, -var12.getStringWidth("§l"+ p_147906_2_) / 2, var17 - 11, 553648127);
		            GlStateManager.enableDepth();
		            GlStateManager.depthMask(true);
		            var12.drawStringWithShadow("§c§l❤§r §a§l" + String.valueOf(h2), -var18 + 2, var17 - 1, (h1 > 10.0F) ? -11141291 : ((h1 > 5.0F) ? -171 : -1));
		            var12.drawStringWithShadow("§9§l❤§r §a§l" + String.valueOf(((EntityLivingBase)p_147906_1_).getTotalArmorValue()), 0 - var12.getStringWidth("§9§l❤§r §a§l" + String.valueOf(((EntityLivingBase)p_147906_1_).getTotalArmorValue())) / 2, var17 - 1, (h1 > 10.0F) ? -11141291 : ((h1 > 5.0F) ? -171 : -1));
		            var12.drawStringWithShadow("§a§lD§r §c§l" + d2, var18 - var12.getStringWidth("§l§aD§r §c§l0.0"), var17 - 1, (d1 > 7.0F) ? -11141291 : ((d1 > 4.0F) ? -171 : -1));
	                
		            Gui.drawRect((-var18), (var17 + var12.FONT_HEIGHT - 1), (-var18 - 1) + (var18 * 2 + 2) * ((EntityLivingBase)p_147906_1_).getHealth() / ((EntityLivingBase)p_147906_1_).getMaxHealth(), (var17 + var12.FONT_HEIGHT), -1878982912);
	                Gui.drawRect((-var18), (var17 + var12.FONT_HEIGHT), (-var18 - 1 + (var18 * 2 + 2) * ((EntityLivingBase)p_147906_1_).getTotalArmorValue() / 20), (var17 + var12.FONT_HEIGHT + 1), -1879047937);
		            
	                Gui.drawRect((-var18), (var17 + var12.FONT_HEIGHT - 21), (-var18 - 1 + (var18 * 2 + 2)), (var17 + var12.FONT_HEIGHT - 22), -1);
	                Gui.drawRect((-var18), (var17 + var12.FONT_HEIGHT + 1), (-var18 - 1 + (var18 * 2 + 2)), (var17 + var12.FONT_HEIGHT + 2), -1);
	                Gui.drawRect((-var18 - 1), (var17 + var12.FONT_HEIGHT - 22), (-var18), (var17 + var12.FONT_HEIGHT + 2), -1);
	                Gui.drawRect((-var18 - 1 + (var18 * 2 + 2)), (var17 + var12.FONT_HEIGHT - 22), (-var18 + (var18 * 2 + 2)), (var17 + var12.FONT_HEIGHT + 2), -1);
	            	
		            var12.drawStringWithShadow("§l" + p_147906_2_, -var12.getStringWidth("§l"+ p_147906_2_) / 2, var17 - 11, -1);
	            }
            	else
                {
                	GlStateManager.func_179098_w();
