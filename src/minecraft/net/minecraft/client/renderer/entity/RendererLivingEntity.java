...
public abstract class RendererLivingEntity extends Render
{
        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {p_76986_1_, this, Double.valueOf(p_76986_2_), Double.valueOf(p_76986_4_), Double.valueOf(p_76986_6_)}))
        {
            ...
            try
            {
                ...
                if (p_76986_1_ == Minecraft.getMinecraft().thePlayer) {
                	var201 = p_76986_1_.rotationPitchHead;
                }
    ...
    protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
        ...
        {
        	if(Client.isEnabled("Chams") != null)
            {
        		if (Chams.invisibleValue.get() && p_77036_1_.isInvisible()) 
        		{
        			var8 = true;
        			var9 = true;
        		} 
        ...
        if (var8 || var9)
        {
            ...
            if((p_77036_1_ instanceof EntityPlayer))
            {
	            if(Client.isEnabled("Chams") != null)
	            {
        			if(!Chams.playerModeValue.is("Default")) 
        			{
            			GL11.glPushMatrix();
