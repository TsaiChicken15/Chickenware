...
public class Gui
{
     ...
     */
    public static void drawRect(float f, float g, float right, float bottom, int color)
    {
    	float var5;
        ...
        var10.addVertex((double)f, (double)bottom, 0.0D);
        var10.addVertex((double)right, (double)bottom, 0.0D);
        var10.addVertex((double)right, (double)g, 0.0D);
        var10.addVertex((double)f, (double)g, 0.0D);
        var9.draw();
