...
public class GuiOptionSlider extends GuiButton
{
    ...
    protected void mouseDragged(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            this.drawRect(this.xPosition + 2f + (int)(this.sliderValue * (float)(this.width - 8)), this.yPosition + 1.7f, this.xPosition - 2f + (int)(this.sliderValue * (float)(this.width - 8)) + 4 + 4, this.yPosition + 18.3f, 0xccffffff);
        }
    }
