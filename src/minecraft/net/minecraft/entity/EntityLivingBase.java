...
public abstract class EntityLivingBase extends Entity
{
    ...
    public int getArmSwingAnimationEnd()
    {
        ...
        if (event.cancelled)
            return isPotionActive(Potion.digSpeed) ? ((int)ViewModel.swingSpeed.get() - (1 + getActivePotionEffect(Potion.digSpeed).getAmplifier()) * 1) : (isPotionActive(Potion.digSlowdown) ? ((int)ViewModel.swingSpeed.get() + (1 + getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2) : (int)ViewModel.swingSpeed.get()); 
