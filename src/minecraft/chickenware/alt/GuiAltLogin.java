...
public final class GuiAltLogin extends GuiScreen 
{
    ...
    private String alphabetlist = "AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz1234567890";
    ...
    protected void actionPerformed(GuiButton button) 
    {
        switch (button.id) 
        {
            ...
            case 2: 
            {
            	...
            	for(int i = 0; i <= 12; i++)
            	{
            		name.append(alphabetlist.charAt((int)(alphabetlist.length() * Math.random())));
            	}
                this.thread = new AltLoginThread(name.toString(), this.password.getText());
                this.thread.start();
            }
            case 0: 
            {
    ...
    public void initGui() 
    {
        ...
        this.buttonList.add(new GuiButton(0, width / 2 - 100, var3 + 72 + 12, 98, 20, "Login"));
        this.buttonList.add(new GuiButton(2, width / 2 + 2, var3 + 72 + 12, 98, 20, "Random"));
